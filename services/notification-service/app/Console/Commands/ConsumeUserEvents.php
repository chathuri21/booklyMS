...
class ConsumeUserEvents extends Command
{
    ...
    protected $description = 'Consume user.* events from the message broker and send notifications';
    ...
    public function handle(UserCreatedHandler $userCreatedHandler): int
    {
        ...
        $queue = config('queue.connections.rabbitmq.options.queue.notification_user_events', 'notification.user_events');
